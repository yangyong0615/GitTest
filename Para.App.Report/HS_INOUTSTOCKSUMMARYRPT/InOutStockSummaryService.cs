...
namespace Para.App.Report.HS_INOUTSTOCKSUMMARYRPT
{
    [HotUpdate]
    [Description("存货收发存汇总表(扩展标准产品报表) - 服务器插件")]
    public class InOutStockSummaryService : Kingdee.K3.FIN.HS.App.Report.InOutStockSummaryService
    {
        string[] temps;
